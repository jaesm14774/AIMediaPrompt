...
│                                                                              │
│  ┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐        │
│  │  7. Viral Score │────▶│  8. Post to FB  │────▶│  9. Upload ImgBB│        │
│  │   /viral-score  │     │   /post-to-fb   │     │auto_upload_imgbb│        │
│  └─────────────────┘     └─────────────────┘     └────────┬────────┘        │
│                                                           │                  │
│                                                           ▼                  │
│                                                  ┌─────────────────┐        │
...
**範例**:
```bash
python scripts/auto_upload_imgbb.py "Prompt名稱" --env dev --type image
```
...
│
├── scripts/
│   ├── auto_upload_imgbb.py           # 上傳到 ImgBB
